...
### **NOTE** IPv4 must be enabled
You can enable or disable IPv6 as you please and IntraMine will work. HOWEVER, IPv4 must be enabled. This is overwhelming the default. If you're not sure, run "ipconfig /all" at a command prompt and look for "IPv4 Address" under the adapter you're using (either Ethernet of Wireless): if you see an address such as 192.168.40.8 listed, you have IPv4 enabled.
...
## Requirements
 - Windows 10 / 11.
 - as mentioned above, IPv4 must be enabled on the PC where IntraMine is installed.
