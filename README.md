...
Please note IntraMine must be installed on a PC running Windows 10/11. And the files you want to monitor for changes (to keep your search index up to date) must be on drives directly attached to the same PC, though library files can be on NAS.
