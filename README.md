...
You already know how to write in-house documentation. Perhaps you take the Microsoft approach to organizing, and invite your readers down the dark dimensions of an endless hierarchy. Or perhaps it's one gigantic hundred-page document. But however you organize, it's difficult to put the relevant definitions and explanations in view when they're needed, not without repetition, or footnotes, or links that take your readers out of the flow.

Here's a better way: write a glossary. Then all the "technical" terms and expressions will acquire a subtle dotted underline, and pausing the mouse over one pops up a rich explanation. No leaving the flow, and no writer's block from wanting to avoid duplication or distraction. That's what IntraMine's glossary popups offer. The popups also have popups by the way, letting you handle technical terms defined in terms of other technical terms by putting all the relevant definitions in your glossary file.

As an example (without meaning to pick on a fine piece of work), the [GitHub Flavored Markdown Spec](https://github.github.com/gfm/) mentions the term "paragraph" fifty times before defining it. A glossary popup could prevent puzzlement there.

For more, see [**glossary popups**](https://htmlpreview.github.io/?https://github.com/KLB7/IntraMine/blob/master/Documentation/Glossary%20popups.html).


_Here's an example showing a primary and secondary poup_
![Popups](https://github.com/KLB7/IntraMine/blob/master/Documentation/images/popups.gif)
...
Here are the top enhancements.

Rich [**glossary popups**](https://htmlpreview.github.io/?https://github.com/KLB7/IntraMine/blob/master/Documentation/Glossary%20popups.html) mean you don't have to worry about using a term before it's defined, or interrupt the flow to provide an intrusive paragraph or long comment: hovering over a defined term shows the definition, complete with rich text, tables, images, and clickable links. They're available in all text and source files when using the Viewer or Editor, and in standalone HTML files generated by the Glosser service. Defined terms within a popup themselves have secondary popups, so you can define a technical term in terms of other technical terms without having to repeat explanations. Glossary popups help your readers, and can also help you avoid writer's block by eliminating repetition.
...
## Requirements
 ...
 - Strawberry Perl 5 version 30 or later. The "Quick Install" will install version 5.40.
